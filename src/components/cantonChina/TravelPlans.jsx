...
<>
  <h2
        className="text-4xl sm:text-6xl font-bold text-red-600 text-center mb-1 mt-12"
        data-aos="fade-down"
      >
         Select Travel Plans
      </h2>
    ...
    >
      {/* Phone Frame */}
      <div
        className="relative w-full max-w-[1100px] px-4 sm:px-0"
        data-aos="zoom-in-up"
        data-aos-delay="100"
      >
        {/* iPhone Image */}
        ...
        <div className="absolute top-[15%] left-[11%] w-[77%] h-[70%] rounded-2xl overflow-hidden shadow-lg">
          <iframe
            width="100%"
            height="100%"
          src="https://www.youtube.com/embed/tR1bi4Y6fzw?si=FJRu3eR2X1HcSwfj"
            title="YouTube video"
            frameBorder="0"
      ...
      {/* Schedule Button */}
   <button
  onClick={onButtonClick}  // 🔥 call modal open
